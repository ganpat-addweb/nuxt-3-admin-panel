            ...
            >
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  >
                    <Icon class="text-red-600 size-6" name="solar:shield-warning-outline"/>
                  </div>
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Delete</DialogTitle>
                    <div class="mt-2">
...
const { isOpen, confirmDelete, cancelDelete } = useDeleteConfirmation();
</script>
